...
two_Words <- readRDS("https://github.com/yohan78/CapstoneFinal/tree/master/data/two_Words.rds")
tree_Words  <- readRDS("https://github.com/yohan78/CapstoneFinal/tree/master/data/tree_Words.rds")
four_Words <- readRDS("https://github.com/yohan78/CapstoneFinal/tree/master/data/four_Words.rds")
